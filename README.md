...
```
$ ~/Programs/hadoop-2.6.0/bin/hdfs dfs -put actors.list hdfs://localhost:9000/actors.list
$ ~/Programs/hadoop-2.6.0/bin/hdfs dfs -put actresses.list hdfs://localhost:9000/actresses.list
$ ~/Programs/hadoop-2.6.0/bin/hdfs dfs -put genres.list hdfs://localhost:9000/genres.list
$ ~/Programs/hadoop-2.6.0/bin/hdfs dfs -put movies.list hdfs://localhost:9000/movies.list
$ ~/Programs/hadoop-2.6.0/bin/hdfs dfs -put plot.list hdfs://localhost:9000/plot.list
$ ~/Programs/hadoop-2.6.0/bin/hdfs dfs -put movies.csv hdfs://localhost:9000/movies.csv
$ ~/Programs/hadoop-2.6.0/bin/hdfs dfs -put ratings.csv hdfs://localhost:9000/ratings.csv
